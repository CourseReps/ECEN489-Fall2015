    ...
    ui(new Ui::MainWindow)
{
    ...
    // start tcp socket
    QThread* thread = new QThread;// toDatabase *database;
...
void MainWindow::sliderValue(){
    ...
    ui->sendht->setEnabled(false);
    QString height = QString::number(ui->hslider->value())+"\n";

     qDebug()<<"set height  "<<height;
    emit sendSetPoint(height);

    ui->sendht->setEnabled(true);
    QString currentlabel = "Current Height = " + height;
    ui->currentht->setText(currentlabel);
}
...
void MainWindow::realtimeDataSlot(){
       ...
       // open the specified database
        db_plot.setDatabaseName("/home/uday/Arduino/Project_2_arduino/Project_2_Arduino/data.db");
