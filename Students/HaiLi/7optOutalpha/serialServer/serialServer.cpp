...
int main(int argc, char *argv[]) {
    ...
    // create table
    char sql[200] = "CREATE TABLE Client_IP( DeviceID TEXT,DeviceType TEXT, Data TEXT,Timestamp TEXT, currentIP TEXT );";
    ...
    for(;;) {
        ...
        // Client binds to any address on port 
        ...
        bool parsingSuccessful = reader.parse(jsonMessage, client_msg);
            ...
            if (parsingSuccessful) {
                ...
                std::string statement =
                        " INSERT INTO Client_IP VALUES(' " + deviceid + " ',' " + devicetype + " ',' " + data + " ',' " +
                        timestamp + " ',' " + currentIP + " ') ";
